...
ADMINS = [("Shshnk Deep", "shashank.deep01@gmail.com")]
...
REST_KNOX = {
    ...
    "TOKEN_TTL": timedelta(days=7), # The default is 10 hours i.e., timedelta(hours=10)).
...
DATA_UPLOAD_MAX_MEMORY_SIZE = 524288000  # 500 MB (adjust as needed)
FILE_UPLOAD_MAX_MEMORY_SIZE = 524288000  # 500 MB (adjust as needed)